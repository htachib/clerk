  ...
  class KeheHebCouponsInactive < Base
    class << self
      def prepare_rows(raw_rows)
        ...
        prepared_row['Promo End Date'] = raw_rows['start_date']
        prepared_row['Promo Start Date'] = raw_rows['end_date']
        ...
        prepared_row['Customer Detailed Name'] = raw_rows['chain']
