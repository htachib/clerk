  ...
  class UnfiEastReclaimVendorChargebackReport < Base
    class << self
      def prepare_rows(raw_rows)
        ...
        prepared_row['Parser'] = 'UNFI East Reclaim Vendor Chargeback Report'
        ...
        prepared_row['Deduction Post Date'] = Date.parse(raw_rows['uploaded_at'].try(:to_s)).strftime("%m/%d/%Y")
